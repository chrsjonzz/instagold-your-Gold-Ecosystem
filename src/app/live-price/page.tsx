      ...
      <div className="container mx-auto px-4 py-16 md:py-32">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg border-2 border-primary/20 bg-card/50">
            <CardHeader>
                <CardTitle className="text-lg sm:text-xl">Live Online Sell Rates (per gram)</CardTitle>
            ...
            <CardContent>
              {loading ? (
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="font-bold text-xs sm:text-sm">City</TableHead>
                      <TableHead className="text-right font-bold text-xs sm:text-sm">24K Rate (INR)</TableHead>
                      <TableHead className="text-right font-bold text-xs sm:text-sm">22K Rate (INR)</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {prices.map((item) => (
                      <TableRow key={item.city}>
                        ...
                        <TableCell className="text-right font-mono text-xs sm:text-sm">₹{item.rate24k.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        <TableCell className="text-right font-mono text-xs sm:text-sm">₹{item.rate22k.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
